...
| --------- | -----    |
| Total population - WorldPop (2020) | The total population estimated to live within the given catchment area, based on [WorldPop](https://hub.worldpop.org/geodata/listing?id=78) gridded population estimates
Total population - WorldPop UN (2020)| The total population estimated to live within the given catchment area, based on [WorldPop](https://hub.worldpop.org/geodata/listing?id=79) gridded population estimates and adjusted to match United Nations national estimates
Total population - Kontur| The total population estimated to live within the given catchment area, based on [Kontur](https://data.humdata.org/organization/kontur) gridded population estimates
Total population - Grid3| The total population estimated to live within the given catchment area, based on [Grid3](https://data.grid3.org/search?tags=gridded%2520population) gridded population estimates
...
OpenStreetMap Buildings| The total count of buildings estimated to be within the catchment area, based on [OSM Buildings](https://osmbuildings.org/)
...
Average Building Footprint (m<sup>2</sup>) | Average square meters of the land area covered by each building in the catchment area based on Google's [Open Buildings](https://sites.research.google/open-buildings/#faq), counting only those features rated with a 80% or greater confidence that they are buildings
