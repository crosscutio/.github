...
| Admin 1 | The admin 1 name(s) associated with the catchment area |
| Admin 2 | The admin 2 name(s) associated with the catchment area (if applicable) |
| Admin 3 | The admin 3 name(s) associated with the catchment area (if applicable) |
| Admin 4 | The admin 4 name(s) associated with the catchment area (if applicable) |
