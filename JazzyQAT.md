...
The initial release of JazzyQAT targets family planning commodities. Since the QAT is no longer available for family planning commodities, we see this as a critical gap with JazzyQAT offering a much needed service. In the future, we hope to expand to other commodity categories including HIV and Malaria.

### Hosting and Maintenance
Crosscut currently hosts and maintains JazzyQAT as a multi-tenant application serving multiple countries. If you would prefer to install your own instance locally, we have significantly eased the process of standing up the application and can provide support to your IT team to quickly install your own instance as needed.
